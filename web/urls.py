...
urlpatterns += i18n_patterns(
    ...
    # path("challenges/<str:challenge_type>-<int:week_number>/submit/", views.challenge_submit, name="challenge_submit"),
    path("challenges/<str:challenge_type>/<int:week_number>/submit/", views.challenge_submit, name="weekly_challenge_submit"),
    path("challenges/<str:challenge_type>/submit/", views.challenge_submit, name="One_time_challenge_submit"),
    # path("challenges/<str:challenge_type>/details/", views.challenge_detail, name="One_time_challenge_detail"),
    # path("challenges/<str:challenge_type>/<int:week_number>/details/", views.challenge_detail, name="weekly_challenge_detail"),
